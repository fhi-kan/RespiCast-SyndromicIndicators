...
When using individual teams’ forecasts, please check the relative metadata file (in the [model-metadata](https://github.com/european-modelling-hubs/RespiCast-SyndromicIndicators/model-metadata) folder) for licensing details and permits.
